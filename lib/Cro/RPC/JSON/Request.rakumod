...
=item C< $.batch> - if request is part of a L<batch request|https://www.jsonrpc.org/specification#batch>
    ...
    L<C<Cro::RPC::JSON::BatchRequest>|https://github.com/vrurg/raku-Cro-RPC-JSON/blob/v0.0.907/docs/md/Cro/RPC/JSON/BatchRequest.md> object
...
Returns a L<C<Cro::RPC::JSON::MethodResponse>|https://github.com/vrurg/raku-Cro-RPC-JSON/blob/v0.0.907/docs/md/Cro/RPC/JSON/MethodResponse.md>
