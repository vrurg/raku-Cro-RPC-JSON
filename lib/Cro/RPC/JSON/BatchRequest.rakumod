...
=item C<$.pending> - number of pending requests, i.e. those for which responses were not completed yet (see L<C<Cro::RPC::JSON::MethodResponse>|https://github.com/vrurg/raku-Cro-RPC-JSON/blob/v0.1.900/docs/md/Cro/RPC/JSON/MethodResponse.md>)
=item C<Promise:D $.completed> – this promise is kept when all responses are completed
=item L<C<Cro::RPC::JSON::BatchResponse>|https://github.com/vrurg/raku-Cro-RPC-JSON/blob/v0.1.900/docs/md/Cro/RPC/JSON/BatchResponse.md>C< $.response> – batch response object paired to this batch request
