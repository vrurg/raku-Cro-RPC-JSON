...
This class is a mediator between JSON-RPC actor code and the connected client. Normally it's only useful for asynchronous mode of operation (see [`Cro::JSON::RPC`](https://modules.raku.org/dist/Cro::JSON::RPC)). And even then it's better be created using [`Cro::RPC::JSON::Request`](Request.md) `response` method.
...
If `Cro::RPC::JSON::MethodResponse` belongs to batch response it reports back to the batch object of [`Cro::RPC::JSON::BatchResponse`](BatchResponse.md) when gets completed.
...
==========
  ...
  * `$.jrpc-request` - [`Cro::RPC::JSON`](../JSON.md) request object to which this response is generated
...
[`Cro`](https://cro.services), [`Cro::RPC::JSON`](../JSON.md), [`Cro::RPC::JSON::Request`](Request.md), [`Cro::RPC::JSON::BatchResponse`](BatchResponse.md)
